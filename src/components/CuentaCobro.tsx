...
export default function CuentaCobro({ residente, deudas, onClose }: any) {
  ...
  return (
    <div className="fixed inset-0 bg-slate-900/60 backdrop-blur-sm z-[300] flex flex-col items-center p-0 md:p-6 overflow-y-auto no-scrollbar">
      ...
      <div id="print-document" className="w-full max-w-4xl bg-white p-8 md:p-16 border border-slate-100 shadow-2xl flex flex-col font-sans print:shadow-none print:border-0 print:p-0">
