...
export default function EstadoCuenta({ residente, deudas, onClose }: any) {
  ...
  return (
    <div className="fixed inset-0 bg-slate-900/40 backdrop-blur-sm z-[300] flex flex-col items-center p-0 md:p-6 overflow-y-auto print-container">
      <style>{`
        @media print {
          /* 1. Resetear el layout para permitir múltiples hojas */
          @page { size: letter; margin: 1.5cm; }
          html, body { height: auto !important; overflow: visible !important; }
          
          /* 2. Ocultar todo el sitio web de fondo */
          body > * { display: none !important; }
          body > .print-container { display: block !important; position: static !important; background: white !important; }

          /* 3. Asegurar que el área de impresión sea visible y ocupe todo el ancho */
          #print-area { 
          ...
          /* 4. Evitar la hoja en blanco: Quitar fondos oscuros y desenfoques */
      ...
      <div id="print-area" className="w-full max-w-4xl bg-white p-8 md:p-12 border border-slate-100 font-sans shadow-2xl">
        ...
        <section className="mb-8">
          <h3 className="text-[9px] font-black uppercase mb-2 flex items-center gap-2 border-b pb-1"><Wallet size={10} /> Deudas Pendientes</h3>
        ...
        <section>
          <h3 className="text-[9px] font-black uppercase mb-2 flex items-center gap-2 border-b pb-1"><History size={10} /> Historial de Pagos</h3>
