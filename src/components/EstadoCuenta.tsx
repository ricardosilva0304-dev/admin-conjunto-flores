    ...
    <div className="fixed inset-0 bg-slate-900/40 backdrop-blur-sm z-[300] flex flex-col items-center p-0 md:p-6 overflow-y-auto no-scrollbar">
      ...
      <style>{`
        @media print { 
          ...
          #print-area { position: relative !important; width: 100% !important; margin: 0 !important; padding: 0 !important; display: block !important; } 
      ...
      <div id="print-area" className="w-full max-w-5xl bg-white p-8 md:p-16 border border-slate-100 shadow-xl flex flex-col text-slate-800 font-sans print:shadow-none print:border-0 print:p-0">
